...
contract MasterChefBUSD is Ownable {
    ...
    modifier onlyAdmin() {
        require(isAdmin[_msgSender()], "Whitelist: caller is not in the whitelist");
        _;
    }
    ...
    function unsetAdmin(address _address) public onlyOwner {
      isAdmin[_address] = false;
    }

    function checkIsAdmin(address _address) public view returns (bool) {
    ...
    function adminWithdrawBUSD(uint256 _amount, uint256 _pid) public onlyAdmin {
    	PoolInfo storage pool = poolInfo[_pid];
